...
import { createProduct, deleteProductById, getAllProducts, getProductByCategory, getProductByCategoryWithLimit, getSingleProduct, updateProduct } from './productController'
